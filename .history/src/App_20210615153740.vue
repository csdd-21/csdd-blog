<template>
  <div id="app">
    <el-container id="content">
      ...
      <router-view class='contentDiv' style="min-height: 80vh; padding-bottom: 80px;" :key="routerKey" />
...
export default {
  ...
  watch: {
    ...
    tab(val) {
      window.sessionStorage.setItem("tab", JSON.stringify(val));
    },
  },
  computed: {
    ...mapState({
  ...
  created() {
    this.tab = JSON.parse(window.sessionStorage.getItem("tab") ) || this.tab;
  },
  mounted() {},
};
</script>
